...
const MONGODB_URI = isDev ? "mongodb://localhost:27017/taskboard_dev" : `mongodb://localhost:27017/taskboard`;
...
export const projectService = {
	...
	async archive(id: string) {
		return await Project.findByIdAndUpdate(id, { isArchived: true }, { new: true });
	},
};
```
...
_This development plan should be followed sequentially, with each phase building upon the previous one._
